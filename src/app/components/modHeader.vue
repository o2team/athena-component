...
<div class="mod_header">
	<div class="mod_header_inner ly_valign">
		<div class="ly_valign_wrap cf">
			<div class="mod_header_inner_l">
				...
				<ul class="mod_header_nav cf">
					<li class="mod_header_nav_item"><a v-link="{name:'list'}">组件</a></li>
					<li class="mod_header_nav_item"><a v-link="{name:'white'}">白名单</a></li>
				</ul>
			</div>
			<div class="mod_header_inner_r"></div>
		</div>
		...
		.mod_header_inner_l {float:left;}
			...
			.mod_header_nav {display:inline-block; margin-left: 30px; vertical-align: middle;}
				.mod_header_nav_item {float: left;}
					...
					.mod_header_nav_item a:hover {border-bottom: 2px solid #6190e8}
		.mod_header_inner_r {float:right;}
</style>